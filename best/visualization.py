...
for appliance in appliances:
    ...
    for method in methods:
        ...
        if method != "ground_truth":
            ...
            file_name_denorm = root_folder + rf"\house_2\resampled_data_{normal}_{dt}.csv"
            file_name_norm = root_folder + rf"\house_2\normalized_data_{normal}_{dt}.csv"
            ...
            if method == "seq2seq":
                ...
                metrics = classification_metrics(y_test_activation, y_pred_activation)
            ...
            file_name_denorm = root_folder + rf"\house_2\resampled_data_std_ratio_30S.csv"
            file_name_norm = root_folder + rf"\house_2\normalized_data_std_ratio_30S.csv"
            df_test = pd.read_csv(file_name_norm, index_col=0, parse_dates=True)       
            df_test_denormalized = pd.read_csv(file_name_denorm, index_col=0, parse_dates=True) 
            test_segment_df = df_test.loc[start_time:end_time]
            df_test_segment_denormalized = df_test_denormalized.loc[start_time:end_time]
...
df_metrics = pd.DataFrame(classification_results)
