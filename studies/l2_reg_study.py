...
folders = [
    ...
    "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.00005",
    "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.0001",
    "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.0002",
    "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.001",
]
...
folder1 = {
    "CNN - dt=60 - dense=256 - batchsize=1024" : "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0",
    "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.00005" : "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.00005",
    "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.0001" : "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.0001",
    "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.0002" : "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.0002",
    "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.001" : "CNN - dt=60 - dense=256 - batchsize=1024 - l2=0.001",
}
l2s = [folder1[folder].split("l2=")[1] for folder in folders]

# Initialize a dictionary to store data
data_dict = {appliance: {method: {l2: None for l2 in l2s} for method in methods} for appliance in appliances}

# Parse CSV files from each folder
parent_dir = os.path.abspath(os.path.join(os.getcwd(), ".."))  # Go one folder back
for folder in folders:
    l2 = folder1[folder].split("l2=")[1]  # Extract batch size
    for file in os.listdir(os.path.join(parent_dir, folder)):
        if file.endswith(".csv") and file!="comparison_metrics.csv":
            ...
            if appliance in appliances and method in methods:
                data_dict[appliance][method][l2] = df
...
for i, appliance in enumerate(appliances):
    for j, method in enumerate(methods):
        ...
        mae_values = []
        for l2 in l2s:
            df = data_dict[appliance][method][l2]
        ...
        # Primary axis (MAE)
        ax.set_xlabel("l2 regularizations")
        ax.set_ylabel("MAE")
...
# Add a main title
fig.suptitle("Comparison of SAE & MAE Across Different l2 regularizations", fontsize=16)
...
results_df = results_df.sort_values(by=["appliance", "method", "l2 regularization"])
