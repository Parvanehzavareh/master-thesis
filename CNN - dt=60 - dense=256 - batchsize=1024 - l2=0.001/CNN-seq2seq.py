...
#appliance = 'fridge_freezer'
    ...
    model.add(Conv1D(filters=30, kernel_size=5,strides=1, activation='relu', input_shape=(window_size, 1), kernel_regularizer=l2(0.001)))
    model.add(Conv1D(filters=30, kernel_size=4,strides=1, activation='relu', kernel_regularizer=l2(0.001)))
    model.add(Conv1D(filters=40, kernel_size=3,strides=1, activation='relu', kernel_regularizer=l2(0.001)))
    model.add(Conv1D(filters=50, kernel_size=3,strides=1, activation='relu', kernel_regularizer=l2(0.001)))
    model.add(Conv1D(filters=50, kernel_size=2,strides=1, activation='relu', kernel_regularizer=l2(0.001)))
