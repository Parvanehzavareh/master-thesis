...
window_size = 93      # number of time steps per input sample (4200 sec)
...
#appliance = 'fridge_freezer'
    ...
    model.add(Conv1D(filters=30, kernel_size=7,strides=1, activation='relu', input_shape=(window_size, 1)))
    model.add(Conv1D(filters=30, kernel_size=5,strides=1, activation='relu'))
    model.add(Conv1D(filters=40, kernel_size=4,strides=1, activation='relu'))
    model.add(Conv1D(filters=50, kernel_size=4,strides=1, activation='relu'))
    model.add(Conv1D(filters=50, kernel_size=3,strides=1, activation='relu'))

    model.add(Flatten())
    model.add(Dense(512, activation='relu')) #1024, 512, 256, 128
